...
#### Keycap [MISC]
По условие имеем файл dump.pcap. Заглянув внутрь с помощью wireshark, убеждаемся в том, что перед нами находится usb capture. По запросу "ctf usb capture" находим скрипт https://ctf-wiki.github.io/ctf-wiki/misc/traffic/protocols/USB/ и запускаем: `python ./script.py dump.pcap`.
